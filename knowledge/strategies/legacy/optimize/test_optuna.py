...
# -*- coding: utf-8 -*-
"""
测试 Optuna 参数优化器 - MACD 策略

运行此脚本将：
1. 优化 MACD 策略参数（100 次试验）
2. 对比优化前后的参数和性能
3. 生成可视化图表
4. 输出优化报告
"""
...
def run_optimization_test():
    ...
    print("=" * 80)
    print("BobQuant Optuna 参数优化测试 - MACD 策略")
    print("=" * 80)
    ...
    for metric in ['total_trades', 'win_rate', 'profit_factor']:
        val_default = metrics_default.get(metric, 0)
        val_optimized = metrics_optimized.get(metric, 0)
        print(f"{metric:<20} {val_default:<15.4f} {val_optimized:<15.4f}")
